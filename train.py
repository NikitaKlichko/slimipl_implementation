...
logger = TensorBoardLogger('/home/shared/nk/asr/slimipl/loggs', name='test_run')
...
pseudo_loader = DataLoader(pseudo_ds, batch_size=val_bs, shuffle=False, collate_fn=pseudo_ds._speech_collate_fn, num_workers=n_works)
